# Generated by Django 2.1.7 on 2019-12-11 20:07
...
def make_dump(apps, schema_editor):
    ...
    for row in range(2,66):
        ...
        skurwysyn = big_answer_helper(poll2, skuwysyn_cell_pair, responder, 'CF')
        dziwka = big_answer_helper(poll2, dziwka_cell_pair, responder, 'CS')

        second_poll.kurwa.add(kurwa)
        second_poll.chuj.add(chuj)
        second_poll.debil.add(debil)
        second_poll.idiota.add(idiota)
        second_poll.szmata.add(szmata)
        second_poll.pizda.add(pizda)
        second_poll.skurwysyn.add(skurwysyn)
        second_poll.dziwka.add(dziwka)
        second_poll.save()
